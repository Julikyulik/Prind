...
public class ServicePrinad {
    ...
    public int updatePrinad(Prinad prinad, int snum) throws IOException {
       return repositoryPrinad.update(prinad, snum);
    }
    public boolean deletePrinad(int snum) throws IOException {
       return repositoryPrinad.deleteByPrinad(snum);
    }
}
